...
public class Client {
        ...
        public static void main(String[] args) throws IOException {
                ...
                BigInteger c1 = new BigInteger(inputString);

                String inputString2 = bf.readLine();
                BigInteger c2 = new BigInteger(inputString2);

                String inputString3 = bf.readLine();
                BigInteger c3 = new BigInteger(inputString3);

                System.out.println("c1: " + c1);
                System.out.println("c2: " + c2);
                System.out.println("c3: " + c3);

                BigInteger[] arr = { c1, c2, c3 };
                String[] Array = new String[3];
                for (int i = 0; i < arr.length; i++) {
                        while (b.compareTo(one) == 1) {
                                Q = a.divide(b);
                                x3 = x1.subtract(x2.multiply(Q));
                                r3 = b;
                                b = a.mod(b);
                                a = r3;
                                x1 = x2;
                        ...
                        BigInteger m = arr[i].modPow(x2, N);

                        ArrayList<BigInteger> Keys = new ArrayList<BigInteger>();
                        Keys.add(m);
                        // ArrayList<String> Array = new ArrayList<String>();

                        for (BigInteger t : Keys) {
                                System.out.println("decrypted keys = " + t);
                                String hexNewValue = t.toString(16);
                ...
                String decmessage = cipher.decrypt(message, Array[2]);
                decmessage = cipher.encrypt(decmessage, Array[1]);
                decmessage = cipher.decrypt(decmessage, Array[0]);
                System.out.println("Enc = " + message.toUpperCase());
                System.out.println("Dec = " + decmessage.toUpperCase());
